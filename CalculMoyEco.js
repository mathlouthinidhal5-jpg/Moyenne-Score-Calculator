...
function calculateMoyenneEconomie() {
  ...
  if (synthese === null) {
    result.textContent = "Moyenne Economie:";
    result.classList.remove("error");
    result.classList.add("gradient-text");
    return;
  }
  ...
  result.textContent = `Moyenne Economie: ${moyenne.toFixed(2)}`;
  result.classList.remove("error");
  result.classList.add("gradient-text");
}
...
// Gestion
function calculateMoyenneGestion() {
  const controleInput = document.getElementById("controleGestion");
  const syntheseInput = document.getElementById("syntheseGestion");
  const result = document.getElementById("moyenGestion");
  ...
  if (synthese === null) {
    result.textContent = "Moyenne Gestion:";
    result.classList.remove("error");
    result.classList.add("gradient-text");
    return;
  }
  ...
  result.textContent = `Moyenne Gestion: ${moyenne.toFixed(2)}`;
  result.classList.remove("error");
  result.classList.add("gradient-text");
}

if (document.getElementById("controleGestion")) {
  document.getElementById("controleGestion").addEventListener("input", calculateMoyenneGestion);
}
if (document.getElementById("syntheseGestion")) {
  document.getElementById("syntheseGestion").addEventListener("input", calculateMoyenneGestion);
}
...
if (document.getElementById("resBtn")) {
  document.getElementById("resBtn").addEventListener("click", () => {
    ...
    const gestion = getNumberFromText("moyenGestion");
    ...
    const totalCoefficients = 19.5 + sportCoefficient;
    const total = (
      arabe * 1 +
      anglais * 1 +
      francais * 1 +
...
function calculateMoyenneScoreTech() {
  try {
    ...
    let totalMoyenne = (technique * 3) + (math * 2) + (physique * 3) + 
                      anglais + francais + arabe + philosophie + 
                      informatique + (tp * 2) + optionContribution;
    ...
    let score = 4 * moyenne + 1.5 * technique + 0.5 * math + 1.5 * physique + 
               francais + anglais + 0.5 * tp;
